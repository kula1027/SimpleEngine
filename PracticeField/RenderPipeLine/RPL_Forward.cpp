#include "RPL_Forward.h"
#include "../Scenes/SceneIncludes.h"
#include "../GameWindow.h"


RPL_Forward::RPL_Forward() {
	InitOffScreenDraw();
}
...
void RPL_Forward::InitOffScreenDraw() {
...
void RPL_Forward::Render(Camera* mainCamera_, RenderData * renderData_){
...
void RPL_Forward::EnableOffSreenBuffer(Camera* cam_) {
